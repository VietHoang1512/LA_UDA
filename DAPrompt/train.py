...
def extend_cfg(cfg):
    """
    Add new config variables for LAPA.
    ...
    cfg.TRAINER.LAPA = CN()
    cfg.TRAINER.LAPA.N_DMX = 16  # number of DSC tokens
    cfg.TRAINER.LAPA.N_CTX = 16  # number of context vectors
    cfg.TRAINER.LAPA.CSC = False  # class-specific context
    cfg.TRAINER.LAPA.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.LAPA.T = 1.0
    cfg.TRAINER.LAPA.TAU = 0.5
    cfg.TRAINER.LAPA.U = 1.0
