...
def arg_parse():
    ...
    # for config
    parser.add_argument('--file_root', type=str, default=r'.',
                        help='model output path')
    parser.add_argument('--data_root', type=str, default=r'/vast/hvp2011/data/office-31/', help='data file path')
    ...
    parser.add_argument('--msf_learning_rate', type=float, default=0.005, help='')
    ...
    for target_name in domain_list:
        ...
        for source_name in domain_list:
            if source_name != target_name:
                ...
                source_path = os.path.join(args.data_root, source_name)
...
def main(args):
    ...
    # args.output_folder = os.path.join(args.file_root, args.backbone, 'MPA_FINAL')
